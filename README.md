...
**저의 현장경험과 AGV Middleware개발 경험을 토대로 직접 기획하고 AI Tool(ClaudeCode or Codex)을 활용**해 구현했습니다. 
AI Tool이 작성한 모든 코드를 ROS2 공식문서와 강의에서 학습한 내용을 기반으로 직접 리팩토링하며 학습목적으로도 사용중입니다.
...
아래 프로젝트들은 일반적인 의미의 대표 포트폴리오라기보다, **기획부터 개발, 배포, 유지보수까지 AI 개발 도구만 사용해서 어느 정도 자연스러운 프로그램을 만들 수 있는지 훈련하는 프로젝트**입니다.
